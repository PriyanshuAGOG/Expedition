(() => {
  ...
  const stylesheets = [
    ...
    'feedback-content-v22.css',
    'feedback-content-v22-qa.css',
    'feedback-content-v22-junctions.css'
  ];
  ...
  const scripts = [
    ...
    'feedback-content-v22.js',
    'feedback-content-v22-junctions.js'
  ];
  ...
  const boot = async () => {
    try {
      ...
      buildMeta?.setAttribute('content', '2026.08.06-botanical-junctions-v22');
    } catch (error) {
