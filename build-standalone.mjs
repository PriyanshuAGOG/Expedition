...
await writeFile(resolve(root, 'World-Diabetes-Day-Expedition-2026-Full-Site.html'), html);
console.log('Built World-Diabetes-Day-Expedition-2026-Full-Site.html');
